  ...
  return (
    <div className="dp-panel">
      <div className="dp-nav">
        <button className="dp-nav__btn" onClick={onPrevMonth}>
          ‹
        </button>
        <span className="dp-nav__label">
          {MONTHS[viewMonth]} {viewYear}
        </span>
        <button className="dp-nav__btn" onClick={onNextMonth}>
          ›
        </button>
      </div>
...
function getPreset(key) {
  ...
  switch (key) {
    ...
    case "7d":
      return { start: sub(6), end: today };
    case "30d":
      return { start: sub(29), end: today };
    case "thisMonth": {
