...
const AVATARS = [
  { id: 0, bg: 'linear-gradient(135deg, #1a1d23, #3a3f4b)', svg: <svg viewBox="0 0 40 40" fill="none"><polygon points="20,6 34,30 6,30" stroke="white" strokeWidth="1.8" fill="none" opacity="0.9"/></svg> },
];

const NAV_ITEMS = [
  { id: 'dashboard', label: 'Панель управления', icon: 'dashboard', live: true },
